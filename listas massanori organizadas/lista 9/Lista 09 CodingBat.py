...
def middle_way(a, b):
  ...
  meioB=b[1]
  entreAB=[]
  entreAB.append(meioA)
  entreAB.append(meioB)
  return entreAB
...
def squirrel_play(temp, is_summer):
  if temp >= 60 and temp <= 90:
    return True
  elif temp >90 and temp <=100 and is_summer is True:
    return True
  elif temp >90 and is_summer is not True:
    return False
  else:
    return False
...
def pego_correndo(speed, is_birthday):
  ...
  if speed <= 60: 
    return 0 
  elif is_birthday is not True and speed >= 61 and speed <= 80:
    return 1
  elif is_birthday is True and speed >= 61 and speed <= 80:
    return 1
  elif is_birthday is not True and speed > 80:
   return 2
  elif is_birthday is True and speed > 80:
    return 2
